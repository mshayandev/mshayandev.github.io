...
export const projects: Project[] = [
  {
    ...
    summary:
      "An AI-driven anti-jamming radio for reliable long-range transmission in interference-heavy environments — built on ESP32-S3 and LoRa.",
    description: [
      "SHARC is my final-year project: an AI-driven anti-jamming wireless communication system aimed at reliable long-range transmission in interference-prone environments.",
      "It runs edge-based ML models with imitation learning to detect jamming in real time and switch channels adaptively — keeping the link alive when the spectrum is under attack. Built on ESP32-S3 with LoRa SX1276/SX1278 radios.",
    ],
    highlights: [
      "Edge ML with imitation learning for real-time jamming detection",
      "Adaptive channel switching to hold the link under interference",
      "Long-range LoRa (SX1276/SX1278) on ESP32-S3 hardware",
    ],
    tech: ["ESP32-S3", "LoRa SX1276/78", "Edge ML", "Imitation Learning", "Python"],
    image: null,
    url: { label: "nexsys.live", href: "https://nexsys.live" },
    featured: true,
    hasDetail: true,
  },
  {
    ...
    description: [
      ...
      "It fuses PIR, ultrasonic, and LDR sensors for intelligent access control, layers on live video streaming, two-way audio, and automated lighting, and wires up Firebase + Twilio so SMS and push alerts reach you within seconds.",
    ],
    highlights: [
      ...
      "Live video streaming, two-way audio & automated lighting",
  ...
  },
  {
    ...
    description: [
      ...
      "Live data shows on a web dashboard and an LCD screen, and a companion mobile app lets admins log in, review historical readings, and receive automated SMS alerts for extreme weather.",
    ],
    highlights: [
      ...
      "Companion mobile app with admin login & historical data",
    ],
  ...
  },
  {
    ...
    highlights: [
      "Dual delegate flows + brand-ambassador application system",
